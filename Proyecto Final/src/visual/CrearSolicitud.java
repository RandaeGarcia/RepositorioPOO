...
public class CrearSolicitud extends JDialog {
	...
	public CrearSolicitud() {
		...
		contentPanel.setLayout(new BorderLayout(0, 0));
		{
			...
			txtIdentificacion.setBounds(65, 8, 186, 17);
			...
			txtNombre.setBounds(65, 38, 186, 17);
			...
			txtCorreo.setBounds(65, 66, 186, 20);
			...
			cbxEmpresa.setBounds(65, 38, 186, 17);
			...
			lblPuestoDisp.setBounds(276, 42, 85, 14);
			...
			spnPuestosDisp.setBounds(365, 39, 81, 20);
